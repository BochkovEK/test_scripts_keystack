...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        '--full-circle',
        type=int,
        help='Number of complete migration cycles (all VMs through all hypervisors)'
    )
    parser.add_argument(
        '--migration-timeout',
        type=int,
...
def get_config(args: argparse.Namespace) -> dict:
    ...
    config = {
        ...
        'full_circle': args.full_circle or int(os.getenv('MIGRATION_TEST_FULL_CIRCLE', 0)),
        'test_mode': 'circle' if args.full_circle else 'duration',
